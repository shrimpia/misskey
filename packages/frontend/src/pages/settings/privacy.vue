	...
	<div class="_gaps_m">
		...
		<FormSection>
			<div class="_gaps_m">
				...
				<SearchMarker :keywords="['default', 'note', 'visibility', 'steal']">
					<MkFolder>
						<template #label><SearchLabel>{{ i18n.ts.defaultNoteVisibility }}（パクる）</SearchLabel><span class="_beta">Shrimpia</span></template>
