...
export const searchIndexes: SearchIndexItem[] = [
	...
	},
	{
		...
		children: [
			...
			},
			{
				id: 'q8KaaudMT',
				label: i18n.ts.defaultNoteVisibility,
				keywords: ['default', 'note', 'visibility', 'steal'],
			},
			{
				id: 'o4Ejtf3g9',
	...
	},
	{
		...
		children: [
			...
			{
				id: 'lPdu2T6ba',
				label: 'ノートに詳細表示ボタンを表示する',
				keywords: ['note', 'info', 'button'],
			},
			{
				id: 'wmdrylX6L',
				label: 'Unnamed marker',
				keywords: ['shrimpia', 'headline'],
			},
			{
				id: 'nUs9hVIPk',
				label: 'エアリプ機能',
			...
			},
			{
				id: 'DBszyJIlT',
				label: '公開範囲に応じた色分け',
				keywords: ['note', 'visibility', 'coloring'],
			},
			{
				id: 'ldw1KxZnm',
				label: 'テキストエリアの自動サイズ調整',
				keywords: ['textarea', 'auto', 'size'],
			},
		],
		label: 'ハイライトタイムラインをホームに表示する',
		keywords: ['ebisskey'],
		path: '/settings/ebisskey',
		icon: 'ti ti-power',
	},
	{
		id: 'tnYoppRiv',
