...
export type AdminEmojiSoundsDeleteRequest = operations['admin___emoji-sounds___delete']['requestBody']['content']['application/json'];
export type AdminEmojiSoundsListResponse = operations['admin___emoji-sounds___list']['responses']['200']['content']['application/json'];
export type AdminEmojiSoundsSetRequest = operations['admin___emoji-sounds___set']['requestBody']['content']['application/json'];
export type AdminEmojiSoundsSetResponse = operations['admin___emoji-sounds___set']['responses']['200']['content']['application/json'];
...
export type EmojiSoundsResponse = operations['emoji-sounds']['responses']['200']['content']['application/json'];
